    ...
    def getAllVenues(self):
        query="""
                ...
                WHERE{?internalID rdf:type schema:Organization.
                       ...
                       ?internalID  schema:identifier ?organizationID.}
                """
        df_final_organizations = get (TriplestoreProcessor.getEndpointUrl(TriplestoreProcessor), query, True)
        ...
        ?Organization schema:identifier ?organizationID.}"""
        df_final_venues = get (TriplestoreProcessor.getEndpointUrl(TriplestoreProcessor), query_1, True)
    ...
    def getAllPublications(self):
        ...
        query_2="""
                ...
                WHERE{?internalID rdf:type schema:Person.
                       ...
                       ?internalID  schema:identifier ?authorID.}
                """
        df_final = get (TriplestoreProcessor.getEndpointUrl(TriplestoreProcessor), query_2, True)
        ...
        df_final_pub = get (TriplestoreProcessor.getEndpointUrl(TriplestoreProcessor), query_3, True)
...
class GenericQueryProcessor(object):
    ...
    def getMostCitedPublication(self):
        ...
        if first_row["doi"] in Publications_dict:
            self.finalresultlist.append(Publications_dict[first_row["doi"]])
